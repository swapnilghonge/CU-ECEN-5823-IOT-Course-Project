...
#define LOWEST_ENERGY_MODE 2    //Keep the board in E2 when not required
#define LETIMER_ON_TIME_MS 175
#define LETIMER_PERIOD_MS 3000      //LETIMER set to 3sec
...
//defines APP_IS_OK_TO_SLEEP depending on Lowest energy mode
